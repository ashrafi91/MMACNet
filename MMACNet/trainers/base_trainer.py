    ...
    def train(self, model, train_dataset, val_dataset=None):
        ...
        for epoch in range(init_epoch, max_epochs):
            ...
            for batch_train in train_loader:
                ...
                if hasattr(raw_model, "regularizer"):
                    batch_loss += raw_model.regularizer(labels=batch_labels)
            ...
            val_outputs = val_labels = val_loss = val_prob = val_pred = None
            if should_eval:
                ...
                if isinstance(self.loss_fn, CrossEntropyLoss):
                    ...
                    val_loss = self.loss_fn(
                        input=val_outputs, target=val_targets
                    )
                    ...
                    val_loss = self.loss_fn(
                        input=val_outputs, target=val_labels
                    )
